...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hsire_date,job_id,salary,manager_id,department_id) VALUES (117,'Sigal','Tobias','sigal.tobias@sqltutorial.org','515.127.4564','1997-07-24',13,2800.00,114,3);
...
Select department_name, min_salary, max_salary from departments, jobs
#group by department_name from
order by department_name asc; 

select department_name, avg(department_name) as "Contagem"
from departments
